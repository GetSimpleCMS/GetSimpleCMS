<tr class="[[tr-class]]">
    ...
    <td>
        <input type="text" class="text" name="cf_[[i]]_key" value="[[key]]"/>
    </td>
    <td>
        <input type="text" class="text" name="cf_[[i]]_label" value="[[label]]"/>
    </td>
    <td>
        <select name="cf_[[i]]_type" class="text short">
    ...
    <td>
        <input type="text" class="text" name="cf_[[i]]_value" value="[[text-options]]"/>
    </td>
    <td class="im-del">
