...
*****************************************************/
	...
	if (count($pagesSorted) != 0) { 
		foreach ($pagesSorted as $page) {	
			...
			$table .= '</td>';
			$table .= '<td class="delete" ><a class="delconfirm" href="inc/deletefile.php?id='. $page['url'] .'" title="'.$i18n['DELETEPAGE_TITLE'].': '. stripslashes(strip_tags(html_entity_decode($page['title']))) .'?" >X</a></td></tr>';
