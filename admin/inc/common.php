...
$GS_constants = array(
	...
	'GSADMINTHEMEFILE'      => 'admin.xml',                   // (str) custom admin xml theme filename
...
$GS_definitions = array(
	...
	'GSEDITORCONFIGFILE'   => 'custom_config.js',                    // (str) wysiwyg editor toobar
	...
	'GSPAGESATTRIB'        => 'getDefaultHtmlEditorAttr',     // (str) class to add to codeeditors used to init codeeditor
