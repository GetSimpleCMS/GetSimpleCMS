...
$GS_definitions = array(
	...
	'GSSTYLE'              => 'wide,sbfixed',                 // (csv) default style modifiers
	...
	'GSWIDEPAGES'          => 'theme-edit,components',        // (csv) pages to apply GSWIDTHWIED on
	'GSALLOWLOGIN'         => true,                           // (bool) allow front end login
	'GSALLOWRESETPASS'     => true,                           // (bool) allow front end password resets
	'GSTHEMEEDITEXTS'      => 'php,css,js,html,htm,txt,xml,', // (csv) file extensions to show and edit in theme editor
	...
	'GSCHMOD'              => 0644,                           // (int) chmod mode legacy
