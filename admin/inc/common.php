...
$GS_constants = array(
	...
	'GSWEBSITEFILE'         => 'website.json',                 // (str) website data filename
	'GSCOMPONENTSFILE'      => 'components.json',              // (str) components data filename
	'GSSNIPPETSFILE'        => 'snippets.json',                // (str) snippets data filename
	'GSAUTHFILE'            => 'authorization.json',           // (str) authorizaton salt data filename
	'GSPLUGINTRIGGERFILE'   => 'plugin-update.trigger',       // (str) plugin update trigger filename
	'GSCSSMAINFILE'         => 'css.php',                     // (str) main css filename
	'GSADMINTHEMEFILE'      => 'admin.json',                   // (str) custom admin xml theme file name
	'GSPAGECACHEFILE'       => 'pages.json',                   // (str) page cache xml file name
	'GSPLUGINSFILE'         => 'plugins.json',                 // (str) plugins xml file name
