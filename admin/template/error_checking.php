 ...
 */
	...
	if ( !requestIsAjax() && file_exists(GSUSERSPATH._id($USR).".xml.reset") && get_filename_id()!='index' && get_filename_id()!='resetpassword' ) {
		...
		// If the password was auto generated, display the "change your password" message
		if (get_cookie("PASSWORD_AUTOGENERATED") == "1") {
			doNotify(sprintf(i18n_r('ER_PWD_CHANGE'),'profile.php'),'error',true);

			// This cookie is not needed anymore, remove it
			gs_unsetcookie("PASSWORD_AUTOGENERATED");
		}
