...
$icondefinition = array(
	'TAB_pages'        => '<i class="fa fa-fw fa-list"></i>',// th th-list table database align-left list-ul list-alt files-o copy
	'TAB_edit'         => '<i class="fa fa-fw fa-plus-square"></i>',// edit
	...
	'TAB_sitemap'      => '<i class="fa fa-fw fa-globe"></i>',// sitemap 
...
// nav status labels
if(isDebug()) echo '<li class="rightnav"><a class="label label-error label_4_80" href="'.$debugInfoUrl.'" target="_blank" title="'.i18n_r('DEBUG_MODE').' - '.i18n_r('ON').'"><span>'.$icondefinition["TAB_debugmode"].'</span></a></li>';
