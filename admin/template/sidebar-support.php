...
<ul class="snav">
	...
	<li><a href="http://get-simple.info/docs/" accesskey="<?php echo find_accesskey(i18n_r('SIDE_DOCUMENTATION'));?>" ><?php echo $site_full_name; ?> <?php i18n('SIDE_DOCUMENTATION'); ?></a></li>
