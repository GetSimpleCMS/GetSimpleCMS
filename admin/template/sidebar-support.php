...
<ul class="snav">
	...
	<li id="sb_healthcheck" class="last_sb"><a href="health-check.php" <?php check_menu('health-check');  ?> accesskey="<?php echo find_accesskey(i18n_r('SIDE_HEALTH_CHK'));?>" ><?php i18n('SIDE_HEALTH_CHK'); ?></a></li>
