...
<ul class="snav">
	...
	<li id="sb_extend" ><a href="<?php echo $site_link_back_url; ?>extend/" target="_blank" accesskey="<?php echo find_accesskey(i18n_r('GET_PLUGINS_LINK'));?>" ><?php i18n('GET_PLUGINS_LINK'); ?></a></li>
</ul>