...
?>
		<div id="footer">
      	...
      	<?php 
      		...
      		$site_credit_link = stripslashes('<a href="'.$site_link_back_url.'">'.i18n_r('POWERED_BY').' '.$site_full_name.' '. $site_version_no.'</a>');
					echo '<p>'. $site_credit_link .'</p>';  
      	?>
      	</div>
      	<div class="gslogo" >
	      	<a href="http://get-simple.info/" ><img src="template/images/getsimple_logo.gif" alt="GetSimple Content Management System" /></a>
	      </div>
      	<div class="clear"></div>
